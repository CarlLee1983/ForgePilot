...
func TestRefreshAndValidation(t *testing.T) {
	now := time.Date(2026, 9, 7, 0, 0, 0, 0, time.UTC)
	state := State{SchemaVersion: SchemaVersion, NextWorkID: 3, Goals: []Goal{{ID: "g", Title: "Goal", Repository: "/repo", Status: GoalActive}}, WorkItems: []Item{
...
func TestSelectionUsesTimestampThenID(t *testing.T) {
	...
	state := State{SchemaVersion: SchemaVersion, NextWorkID: 4, Goals: []Goal{{ID: "active", Title: "Active", Repository: "/repo", Status: GoalActive}, {ID: "blocked", Title: "Blocked", Repository: "/repo", Status: GoalBlocked}}, WorkItems: []Item{
